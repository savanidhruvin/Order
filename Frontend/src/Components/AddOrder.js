    ...
    <div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg mt-4 p-4 sm:p-6 mb-4 sm:mb-6">
        ...
        <div className="mt-4 sm:mt-6 bg-gray-50 p-3 sm:p-4 rounded-md flex items-center gap-2">
          <input type="checkbox" className="accent-purple-600 w-4 h-4 sm:w-5 sm:h-5" />
    ...
    <div>
      <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="flex gap-2 sm:gap-3 bg-green-50 border border-green-200 rounded-md p-3 sm:p-4">
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-green-100 flex items-center justify-center text-green-600 shrink-0 text-sm sm:text-base"><FaBagShopping /></div>
          <div>
